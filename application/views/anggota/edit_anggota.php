              ...
              <form role="form" action="<?php echo base_url('Anggota_controller/edit/' . $anggota->id_anggota) ?>" method="post">
                ...
                <div class="box-body">
                  <div class="form-group">
                    <label>NIK</label>
                    <input name="nia" class="form-control <?php echo form_error('nia') ? 'is-invalid' : '' ?>" placeholder="Masukan NIK" value="<?php echo $anggota->nia ?>" type="text" />
                  ...
                  <div class="form-group">
                    <label>KK</label>
                    <input name="kk" class="form-control <?php echo form_error('kk') ? 'is-invalid' : '' ?>" placeholder="Upload Foto" accept=".png, .jpeg, .jpg" type="file" />
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input name="srt_pengantar" class="form-control <?php echo form_error('srt_pengantar') ? 'is-invalid' : '' ?>" placeholder="Upload Foto" accept=".png, .jpeg, .jpg" type="file" />
                  </div>
                </div>
                <!-- /.box-body -->
