  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          <li><a><i class="fa fa-fw fa-child"></i> Data Warga</a></li>
          <li><a>Lihat Data Warga</a></li>
        </ol>
      </section>
                  ...
                  <tbody>
                    ...
                    <?php foreach ($anggota as $value) : ?>
                      <tr>
                        ...
                        <td> <img src="<?php echo base_url() . './upload/kk/' . $value->kk; ?>" style="width: 10rem;" class=" card-img-top" alt="..."></td>
                        <td><?php cetak($value->jenis_kelamin)  ?></td>
                        <td><?php cetak($value->alamat)  ?></td>
                        <td> <img src="<?php echo base_url() . './upload/surat_pengantar/' . $value->srt_pengantar; ?>" style="width: 10rem;" class=" card-img-top" alt="..."></td>
                        <td>
