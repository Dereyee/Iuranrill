    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo base_url('Anggota_controller') ?>">Lihat Data Warga</a></li>
        </ol>
      </section>
            ...
            <div class="box">
              ...
              <div class="box-body table-responsive">
                <div class="box-header">
                  <h3 class="label label-primary" style="">--- Data Warga ---</h3>
                </div>
                <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td> <img src="<?php echo base_url() . '/upload/kk/' . $anggota->kk; ?>" style="width: 10rem;" class=" card-img-top" alt="..."></td>
                      ...
                      <td> <img src="<?php echo base_url() . '/upload/surat_pengantar/' . $anggota->srt_pengantar; ?>" style="width: 10rem;" class=" card-img-top" alt="..."></td>
                    </tr>
