              ...
              <form role="form" action="<?php echo base_url('Pegawai_controller/add') ?>" method="post">
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <input name="password" class="form-control <?php echo form_error('password') ? 'is-invalid' : '' ?>" placeholder="Masukan Password" type="password">
                    <div class="invalid-feedback">
                  ...
                  <div class="form-group">
                    ...
                    <div class="radio">
                      <label>
                        <input type="radio" class="<?php echo form_error('jabatan') ? 'is-invalid' : '' ?>" name="jabatan" value="Sekertaris">
                        Sekertaris
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" class="<?php echo form_error('jabatan') ? 'is-invalid' : '' ?>" name="jabatan" value="Bendahara">
                        Bendahara
                      </label>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="radio">
                      <label>
                        <input type="radio" class="<?php echo form_error('hak_akses') ? 'is-invalid' : '' ?>" name="hak_akses" value="Sekertaris">
                        Sekertaris
                      </label>
                    </div>
                    <div class="radio">
                      <label>
                        <input type="radio" class="<?php echo form_error('hak_akses') ? 'is-invalid' : '' ?>" name="hak_akses" value="Bendahara">
                        Bendahara
                      </label>
                    </div>
                  </div>
